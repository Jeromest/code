...
public class Tetris extends JPanel {
	...
	/** 定义三个常量：充当游戏的状态 */
	public static final int PLAYING = 0;//正在游戏
	public static final int PAUSE = 1;//暂停游戏
	...
	public void paintScore(Graphics g) {	//显示得分和消除行数
	...
	public void start() {
		...
		KeyListener l = new KeyAdapter() {
			 ...
			 */
			public void keyPressed(KeyEvent e) {//获取按键
				// 获取一下键子的代号
